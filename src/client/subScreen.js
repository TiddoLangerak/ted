...
import { startAlternateBuffer } from './screen';
...
export default function subScreen(command, args = [], opts = {}) {
	...
	child.on('close', () => {
		//It is very well possible that the child process closed the alternate buffer. To prevent messing
		//up command history, we start one just in case.
